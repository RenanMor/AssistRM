...
| `GOOGLE_CREDENTIALS_FILE` | Caminho do arquivo secreto com o JSON (Render) |
...
4. Em **Environment**, adicione:
   - **Environment Variable**: `GROQ_API_KEY` (sua chave Groq)
   - **Secret File**: crie um novo arquivo secreto, nomeie como `google_credentials.json`, e cole o JSON completo da Service Account
